...
wbactivities = {'ui:AppendRange', 'ui:GetTableRange', 'ui:ReadCell', 'ui:ReadCellFormula', 'ui:ReadColumn', 'ui:ReadRange', 'ui:ReadRow', 'ui:WriteCell', 'ui:WriteRange'}

# Set of Open/Attach Scopes (as of 18.4.3)
wndscopes = {'ui:ElementScope', 'ui:WindowScope', 'ui:BrowserScope', 'ui:OpenApplication', 'ui:OpenBrowser'}

# Set of Special keys (as of 18.4.3)
specialkey = {
  'add', 'alt', 'lalt', 'ralt', 'back', 'break', 'caps', 'ctrl', 'lctrl', 'rctrl', 'decimal', 'del', 'div', 'down', 'end', 'enter', 'numEnter', 'esc',
  'f1', 'f2', 'f3', 'f4', 'f5', 'f6', 'f7', 'f8', 'f9', 'f10', 'f11', 'f12', 'home', 'ins', 'left', 'mul', 'num',
